...
/**
 * Tente d'appliquer la migration P6 via plusieurs canaux. Si tous échouent,
 ...
 *
 * Usage:
 *   npx tsx scripts/apply-migration-p6.ts
 */
import { execSync } from "node:child_process";
import { readFileSync, existsSync } from "node:fs";
import { resolve } from "node:path";

const MIGRATION_PATH = resolve(__dirname, "../supabase/migrations/0003_p6_influencer_referral.sql");
